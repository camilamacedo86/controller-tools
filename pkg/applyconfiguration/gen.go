...
func (ctx *ObjectGenCtx) generateForPackage(root *loader.Package) error {
	...
	// Gengo uses os.Args[0] to determine the tool name in generated file headers.
	// Temporarily set it to "applyconfiguration" to ensure the header reads
	// "Code generated by applyconfiguration" instead of "Code generated by controller-gen".
	origArgs0 := os.Args[0]
	os.Args[0] = "applyconfiguration"
